...
def test_sub_agents():
    ...
    agent_ids = []
    for i in range(1, 4):
        result = spawn_tool.execute(f"Task {i}: Count to 100 and save to count_{i}.txt", "Qwen3-Coder-Next-Abliterated-Q8_0")
    ...
    result = spawn_tool.execute("Task 4: Should fail due to limit", "Qwen3-Coder-Next-Abliterated-Q8_0")
    ...
    result = spawn_tool.execute("Task 5: Should succeed after kill", "Qwen3-Coder-Next-Abliterated-Q8_0")
