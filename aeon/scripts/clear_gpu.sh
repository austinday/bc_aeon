...
docker rm -f aeon_vllm aeon_gemma4_node0 aeon_gemma4_node1 aeon_gemma_lb aeon_qwen36_vl aeon_gemma4_mtp aeon_gemma4_mtp_node0 aeon_gemma4_mtp_node1 aeon_gemma_mtp_lb aeon_cyberneurova >/dev/null 2>&1 || true
