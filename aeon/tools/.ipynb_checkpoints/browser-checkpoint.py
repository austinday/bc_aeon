...
BROWSER_DIRECTIVES = [
    "Meticulously verify email parameters (timestamp, sender, subject, contents) before proceeding. "
    "Do not rely solely on the visual analysis tool to 'find' information; read the markdown/text content carefully."
]
...
class BrowserNavigateTool(BaseTool):
    def __init__(self, worker=None):
        super().__init__(name="browser_navigate", description=TOOL_DESC_BROWSER_NAVIGATE, directives=BROWSER_DIRECTIVES)
...
class BrowserInteractTool(BaseTool):
    def __init__(self, worker=None):
        super().__init__(name="browser_interact", description=TOOL_DESC_BROWSER_INTERACT, directives=BROWSER_DIRECTIVES)
