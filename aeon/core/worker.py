            ...
            try:
                ...
                if max_iterations is not None and iteration > max_iterations:
                    if not graceful_exit_triggered:
                        ...
                        # We continue the loop to let the agent see the observation and act
                        # Do NOT break yet
                    else:
                        # Already warned, now kill it
...
"""
                ...
                try:
                    ...
                    self.print_func(f"{C_CYAN}Plan Update:{C_RESET} {self.current_plan[:150]}...")
                ...
                for idx, action_data in enumerate(actions):
                    ...
                    if tool_name in terminal_tools:
                        # EXECUTE the tool to get the return value (e.g., the report)
                        try:
